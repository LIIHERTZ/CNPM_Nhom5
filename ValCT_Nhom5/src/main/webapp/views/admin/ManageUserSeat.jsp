            ...
            <div class="container">
                <div class="page-title-area">
                    ...
                    <div class="item date-item">
                        <span class="date">
                            <!-- Hiển thị ngày chiếu -->
                            <h4>Date Screening</h4>
                            <h4><fmt:formatDate value="${screening.screeningDate}" pattern="dd-MM-yyyy" /></h4>
                        </span>
                    </div>
                    <div class="item">
                        <h5 class="title">
                                                ...
                                                <li class="single-seat 
                                                    ...
                                                    <label class="seat-label" 
                                                        ...
                                                        <img src="/ValCT_Nhom5/assets/images/movie/${seatCoupleMap[seatStatus.seat.seatID] == 1 
                                                              ? (seatStatus.status ? 'seat02-booked.png' : 'seat02.png') 
                                                              : (seatStatus.status ? 'seat01-booked.png' : 'seat01.png')}" 
