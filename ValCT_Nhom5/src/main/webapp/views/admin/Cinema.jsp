...
<body>
					...
					<div class="main__title">
						<h2>
							<a href="${pageContext.request.contextPath}/admin/cinemas"
								style="text-decoration: none; color: inherit;"> Cinemas </a>
						</h2>
						<span class="main__title-stat">Total Cinemas :
							${noOfRecords}</span>
						<div class="main__title-wrap">
							<button class="main__title-link main__title-link--wrap"
								data-bs-toggle="modal" data-bs-target="#modal-add-cinema">Add
								Cinema</button>

							<!-- search -->
							<form
								action="${pageContext.request.contextPath}/admin/searchCinema"
								method="get" class="main__title-form">
								<input type="text" name="keyword"
									placeholder="Find cinema by location..">
								<button type="submit">
							...
							<tbody>
								<c:forEach var="cinema" items="${cinemas}">
									<tr>
										...
										<td><div class="catalog__text">
												<a
													href="${pageContext.request.contextPath}/admin/rooms?id=${cinema.cinemaID}">${cinema.cinemaName}</a>
											</div></td>
										...
										<td><div
												class="catalog__text ${cinema.status ? 'catalog__text--green' : 'catalog__text--red'}">${cinema.status ? 'Active' : 'Inactive'}</div></td>
										<td>
											<div class="catalog__btns">
												<a
													href="${pageContext.request.contextPath}/admin/editCinema?id=${cinema.cinemaID}"
					...
					<div class="col-12">
						<div class="main__paginator">
							...
							<ul class="main__paginator-list">
								<!-- Previous Page Link -->
								<li><a
									href="<c:url value='/admin/cinemas'>
	...
	<!-- add cinema modal -->
	<div class="modal fade" id="modal-add-cinema" tabindex="-1"
		aria-labelledby="modal-add-cinema" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<form action="${pageContext.request.contextPath}/admin/addCinema"
					...
					<div class="row">
						<div class="col-12">
							...
							<div class="sign__group">
								<input type="text" class="sign__input" name="cinema_name"
						...
						<div class="col-12">
							...
							<div class="sign__group">
								<input type="text" class="sign__input" name="address"
						...
						<div class="col-12">
							...
							<div class="sign__group">
								<input type="text" class="sign__input" name="location"
									placeholder="Location" required>
							</div>
						</div>

						<div class="col-12">
							<label class="sign__label" for="num_rooms">Number of
								Rooms</label>
							<div class="sign__group">
								<input type="number" class="sign__input" name="num_rooms"
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<div class="modal__content">
					<form
						action="${pageContext.request.contextPath}/admin/deleteCinema"
						method="POST" id="deleteCinemaForm" class="modal__form">
						<h4 class="modal__title">Delete Cinema</h4>
						<p class="modal__text">Are you sure you want to permanently
							delete this cinema?</p>
