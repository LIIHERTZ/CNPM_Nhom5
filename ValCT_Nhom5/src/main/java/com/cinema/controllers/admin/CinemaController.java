...
@WebServlet(urlPatterns = {"/admin/addCinema", "/admin/showAddCinema", "/admin/editCinema", "/admin/deleteCinema", "/admin/searchCinema", "/admin/cinemas"})
public class CinemaController extends HttpServlet {
    ...
    public void init() throws ServletException {
        super.init();
        cinemaService = new CinemaServiceImpl(); // Assume CinemaServiceImpl is the implementation class for handling business logic
    }
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        switch (action) {
//            case "/admin/showAddCinema":
//                showAddCinemaForm(req, resp);
//                break;
...
//    }
    ...
    private void showEditCinemaForm(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
