					...
					<div class="col-12 col-xl-12">
						...
						<div class="sign__group">
							<input type="text" class="sign__input" name="category"
								value="${Movie.category}" placeholder="Category" required>
						</div>
						...
						<div class="col-6">
							...
							<div class="sign__gallery">
								<label id="gallery1" for="sign__gallery-upload">Upload
									...
									onchange="chooseFile(this)" value="${Movies.image}">
						...
						<div id="image-preview-container" style="margin-left: 200px;">
							<c:choose>
									<c:when
										test="${Movie.image.substring(0,5) != 'https'}">
										<c:url value="/image?fname=${Movie.image}"
											var="imgUrl"></c:url>
									</c:when>
									<c:otherwise>
