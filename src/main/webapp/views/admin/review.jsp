				...
				<div class="col-12">
					<div class="main__paginator">
						...
						<ul class="main__paginator-list">
							...
							<li><a
								href="/ValCT_Nhom5/adminReview?movieID=${movieId}&page=${currentPage > 1 ? currentPage - 1 : 1}">
									<i class="ti ti-chevron-left"></i> <span>Prev</span>
							</a></li>
							<!-- Nút Next: chỉ hoạt động khi currentPage < totalPages -->
							<li><a
								href="/ValCT_Nhom5/adminReview?movieID=${movieId}&page=${currentPage < totalPages ? currentPage + 1 : totalPages}">
						...
						<ul class="paginator">
							...
							<c:forEach begin="0" end="${totalPages - 1}" var="i">
								<li
									...
									<a
									href="/ValCT_Nhom5/adminReview?movieID=${movieId}&page=${i + 1}">${i + 1}</a>
								</li>
							</c:forEach>
