...
<body>
    ...
    <section class="account-section bg_img">
        <div class="container">
            ...
            <h2 style="visibility: hidden;">dhsau</h2>
            <h1 style="font-size: 50px; font-weight: normal;">Transaction History</h1>
        </div>
    </section>
    ...
    <tbody>
        <c:forEach var="ticket" items="${ticketHistory}" varStatus="status">
            <tr>
                ...
                <td>${ticket.chairNumber}</td>
                <td><fmt:formatDate value="${ticket.startHour}" pattern="HH:mm dd-MM-yyyy" /></td>
                <td><fmt:formatDate value="${ticket.endHour}" pattern="HH:mm dd-MM-yyyy" /></td>
        ...
        <ul class="pagination">
            <c:forEach var="i" begin="0" end="${totalPages - 1}">
                <li>
                    <a href="${pageContext.request.contextPath}/userTransaction?personId=${personId}&page=${i}"
