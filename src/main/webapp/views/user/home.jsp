...
.movie-content span {
	...
	<section class="banner-section">
		<div class="banner-bg bg_img bg-fixed"
			data-background="assets/images/banner/banner01.jpg"></div>
		<div class="container">
									...
									<c:if test="${movie.image != null}">
										<c:choose>
											...
											<c:otherwise>
												...
												<img src="${movieImgUrl}" class="card-img-top"
													alt="${movie.movieName}">
											</c:otherwise>
										</c:choose>
									</c:if>
								...
								<div class="movie-content bg-one">
									...
									<ul class="movie-rating-percent">
										<li>
											...
											</div> <span class="content">Category: ${movie.category}</span>
										</li>
										<li>
											<div class="thumb">
												<img src="assets/images/movie/cake.png" alt="duration">
											</div> <span class="content">Duration:
												${movie.movieDuration}</span>
										</li>
									</ul>
								</div>
							</div>
			...
			<div class="owl-carousel-wrapper">
				<ul id="movies-coming-carousel" class="owl-carousel owl-theme">
					<c:forEach var="movie" items="${moviesComingSoon}">
						<div class="movie-grid">
							<div class="movie-thumb c-thumb">
								<a href="#0"> <c:if test="${movie.image != null}">
										<c:choose>
											<c:when test="${movie.image.substring(0, 5) == 'https'}">
												<img src="${movie.image}" class="card-img-top"
													alt="${movie.movieName}">
							...
							<div class="movie-content bg-one">
								...
								<ul class="movie-rating-percent">
									...
									<li>
										<div class="thumb">
											<img src="assets/images/movie/cake.png" alt="duration">
										</div> <span class="content">Duration: ${movie.movieDuration}</span>
									</li>
								</ul>
							</div>
						</div>
