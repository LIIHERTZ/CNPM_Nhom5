...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/jquery.animatedheadline.css">
...
<body>
    ...
    <script src="${pageContext.request.contextPath}/assets/js/heandline.js"></script>
